...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "chakrabortytushar684@gmail.com",
    href: "mailto:chakrabortytushar684@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 9064210874",
    href: "tel:+91 9064210874",
  },
  {
    icon: MapPin,
    label: "Location",
    value: "Durgapur, Paschim Burdwan, West Bengal, India",
    href: "#",
  },
];
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 md:py-3.5 bg-surface rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 md:py-3.5 bg-surface rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none"
                />
              </div>
